...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true)
    try {
      const user = await login(form.email.trim(), form.password, remember, 'admin')
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col items-start gap-4 mt-0 max-[600px]:gap-3">
              <img
                ...
                alt="Benzi AI bot"
                className="h-56 object-contain shrink-0 max-[1024px]:h-44 max-[480px]:h-32 mt-6"
              />
            </div>
          </div>
